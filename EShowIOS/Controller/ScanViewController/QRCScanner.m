...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self){
        ...
        _transparentAreaSize = CGSizeMake(300, 300);
        _cornerLineColor = [UIColor greenColor];
        _scanningLieColor = [UIColor colorWithRed:(63.0 / 255.0) green:(189.0 / 255.0) blue:(122.0 / 255.0) alpha:1.0f];
    }
    return self;
}
...
//    _lightButton = [[UIButton alloc]initWithFrame:CGRectMake((self.bounds.size.width - 40)/2, [UIScreen mainScreen].bounds.size.height/2.0-200, 40, 40)];
...
//        _isOn = YES;
//    }else{
//        [_lightButton setBackgroundImage:[UIImage imageNamed:@"scan_light_open"] forState:UIControlStateNormal];
//        _isOn = NO;
//    }
