...
- (void)_sortDataArray:(NSArray *)buddyList
{
    ...
    for (NSString *buddy in contactsSource) {
        ...
        if (model) {
            ...
            NSString *firstLetter = [ChineseToPinyin pinyinFromChiniseString:[[UserProfileManager sharedInstance] getNickNameWithUsername:buddy]];
    ...
    for (int i = 0; i < [sortedArray count]; i++) {
        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(EaseUserModel *obj1, EaseUserModel *obj2) {
            NSString *firstLetter1 = [ChineseToPinyin pinyinFromChiniseString:obj1.buddy];
            firstLetter1 = [[firstLetter1 substringToIndex:1] uppercaseString];
            
            NSString *firstLetter2 = [ChineseToPinyin pinyinFromChiniseString:obj2.buddy];
