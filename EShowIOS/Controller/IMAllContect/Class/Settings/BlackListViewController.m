...
- (NSMutableArray *)sortDataArray:(NSArray *)dataArray
{
    ...
    for (NSString *username in dataArray) {
        ...
        NSString *firstLetter = [ChineseToPinyin pinyinFromChiniseString:username];
    ...
    for (int i = 0; i < [sortedArray count]; i++) {
        NSArray *array = [[sortedArray objectAtIndex:i] sortedArrayUsingComparator:^NSComparisonResult(NSString *obj1, NSString *obj2) {
            NSString *firstLetter1 = [ChineseToPinyin pinyinFromChiniseString:obj1];
            firstLetter1 = [[firstLetter1 substringToIndex:1] uppercaseString];
            
            NSString *firstLetter2 = [ChineseToPinyin pinyinFromChiniseString:obj2];
