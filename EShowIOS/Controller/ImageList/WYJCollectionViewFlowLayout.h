...
@interface WYJCollectionViewFlowLayout : UICollectionViewFlowLayout
@property (nonatomic,assign) BOOL panGestureRecognizerEnable;
@property (nonatomic, assign) NSInteger itemCount;

@end
@protocol WYJCollectionViewFlowDataSource <UICollectionViewDataSource>
...
@protocol WYJCollectionViewDelegateFlowLayout <UICollectionViewDelegateFlowLayout>
