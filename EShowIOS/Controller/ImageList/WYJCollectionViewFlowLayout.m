...
@interface WYJCollectionViewFlowLayout ()<UIGestureRecognizerDelegate>
@property (nonatomic,readonly) id<WYJCollectionViewFlowDataSource> dataSource;
@property (nonatomic,readonly) id<WYJCollectionViewDelegateFlowLayout> delegate;

@end
@implementation WYJCollectionViewFlowLayout
{
...
- (id<WYJCollectionViewFlowDataSource>)dataSource
{
    return (id<WYJCollectionViewFlowDataSource>)self.collectionView.dataSource;
}

- (id<WYJCollectionViewDelegateFlowLayout>)delegate
{
    return (id<WYJCollectionViewDelegateFlowLayout>)self.collectionView.delegate;
}
...
- (void)longPressGestureRecognizerTriggerd:(UILongPressGestureRecognizer *)longPress
{
    switch (longPress.state) {
        ...
        case UIGestureRecognizerStateBegan:
        {
            ...
            ImageSaveCollectionViewCell *sourceCell = (ImageSaveCollectionViewCell *)sourceCollectionViewCell;
