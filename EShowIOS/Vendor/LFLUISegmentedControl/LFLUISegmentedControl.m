...
#pragma mark -----buttonDown 设置下划线颜色
            [buttonDown setBackgroundColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    self.selectColor=[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1];
    //    整体背景颜色
