...
//    [self.navigationController.navigationBar setTintColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];//返回按钮的箭头颜色
...
//    [self.navigationController.navigationBar setTitleTextAttributes:textAttributes];
    ...
    [self.navigationItem.rightBarButtonItem setTintColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];
...
//    [backButton setTintColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];
//    [backButton.titleLabel setTextColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];
//    backButton.titleLabel.font = [UIFont systemFontOfSize:15];
//    [backButton addTarget:self action:@selector(popViewControllerAnimated:) forControlEvents:UIControlEventTouchUpInside];
//    UIBarButtonItem* backButtonItem = [[UIBarButtonItem alloc] initWithCustomView:backButton];
//    [backButtonItem setTintColor:[UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1]];
//    self.navigationItem.leftBarButtonItem = backButtonItem;
    self.title= @"选择照片";
//    _showTakePhotoBtn = (([_model.name isEqualToString:@"选择照片"]) && tzImagePickerVc.allowTakePicture);
...
- (void)configCollectionView {
    ...
    CGFloat margin = 10;
    CGFloat itemWH = (self.view.tz_width - 2 * margin - 10) /3.0;
    layout.itemSize = CGSizeMake(itemWH, itemWH);
    layout.minimumInteritemSpacing = 5;
    layout.minimumLineSpacing = 5;
    CGFloat top = margin + 44;
    if (iOS7Later) top += 20;
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, top, self.view.tz_width , self.view.tz_height - 50 - top) collectionViewLayout:layout];
    ...
    if (iOS7Later) _collectionView.contentInset = UIEdgeInsetsMake(0, 10, 5, 10);
    _collectionView.scrollIndicatorInsets = UIEdgeInsetsMake(0, 0, 0, -2);
    
//    TZImagePickerController *tzImagePickerVc = (TZImagePickerController *)self.navigationController;
//    if (_showTakePhotoBtn && tzImagePickerVc.allowTakePicture ) {
//        _collectionView.contentSize = CGSizeMake(self.view.tz_width, ((_model.count + 4) / 3.0) * self.view.tz_width);
//    } else {
//        _collectionView.contentSize = CGSizeMake(self.view.tz_width, ((_model.count + 3) / 3.0) * self.view.tz_width);
//    }
...
//    }
    ...
    [_okButton setTitle:[NSString stringWithFormat:@"确定(%zd)",tzImagePickerVc.selectedModels.count] forState:UIControlStateNormal];
...
- (void)refreshBottomToolBarStatus {
    ...
    {
        [_okButton setTitle:[NSString stringWithFormat:@"确定(%zd)",imagePickerVc.selectedModels.count] forState:UIControlStateNormal];
    }
