...
- (void)viewDidLoad {
    ...
    //    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(cancel)];
...
//    [self.navigationController.navigationBar setTitleTextAttributes:textAttributes];
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(186 / 255.0f) green:(186 / 255.0f) blue:(186 / 255.0f) alpha:1.0];
    
    if (iOS7Later) {
//        self.navigationBar.barTintColor = [UIColor colorWithRed:(34/255.0) green:(34/255.0)  blue:(34/255.0) alpha:1.0];
        self.navigationBar.tintColor = [UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1];
    ...
    textAttrs[NSForegroundColorAttributeName] = [UIColor colorWithRed:(247 / 255.0f) green:(105 / 255.0f) blue:(86 / 255.0f) alpha:1];
    textAttrs[NSFontAttributeName] = [UIFont systemFontOfSize:kNavTitleFontSize];
