...
- (void)setupToolbars
{
    ...
    indexLabel.bounds = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 30);
...
//    pageControl.currentPageIndicatorImage = currentPageIndicatorImage;
    ...
    pageControl.frame = CGRectMake(70, self.bounds.size.height-20, [UIScreen mainScreen].bounds.size.width-140, 20);
    pageControl.userInteractionEnabled = NO;
//    pageControl.enabled = NO;
    pageControl.hidesForSinglePage = NO;
    pageControl.currentPage = 0;
    //    pageControl.pageIndicatorTintColor = SGAlphaColor(150, 150, 150, 0.4);
...
- (void)layoutSubviews
{
    ...
    _saveButton.frame = CGRectMake(30, self.bounds.size.height - 30, 40, 25);
}
