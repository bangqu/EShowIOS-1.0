...
- (void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    [self  setImageWithURL:url
         ...
         imageViewWeak.progress = (CGFloat)receivedSize / expectedSize;
                ...
                completed:^(UIImage *image, NSError *error, EMSDImageCacheType cacheType) {
...
//     [self setImageWithURL:<#(NSURL *)#> placeholderImage:<#(UIImage *)#> completed:<#^(UIImage *image, NSError *error, SDImageCacheType cacheType)completedBlock#>]
